-- Repair Quote-to-Order conversion schema drift without changing the Quote table.
-- public.quotes stores optional phone inside authoritative quote_data.fields; legacy records may omit it.
