...
describe('Draft cloud configuration and auth states', () => {
  ...
  it('reads and validates the newest authenticated shared snapshot', async()=>{
    const ranking={source:'FantasyPros ECR',sourceClass:'ANALYST_INTERPRETATION',updatedAt:'2026-08-15T12:00:00Z',overallRank:1,scoringFormat:'PPR',freshness:'FRESH'};
    const player={canonicalPlayerId:'nfl:fantasypros:1',displayName:'Real Player',normalizedName:'real player',position:'RB',baselineRank:1,sourceValues:[ranking],newsItems:[],freshness:'FRESH',quality:'COMPLETE',uncertaintyFlags:[],sourceProvenance:[ranking]};
