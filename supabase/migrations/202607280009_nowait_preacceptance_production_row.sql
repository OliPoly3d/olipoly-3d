...
-- Make every Production-row acquisition nonblocking while retaining both
-- advisory try-locks, row authority, receipts, optimistic concurrency, evidence
-- validation, RLS posture, and grants.
