-- TEMPORARY DIAGNOSTIC ONLY: deploy to identify the exact statement boundary for
-- the live Pass QC timeout. Remove with the paired clean-function deployment after
-- capturing one correlation ID. This migration changes logging only.
begin;
...
begin
  raise log 'OP_ATTEMPT_CONSUME marker=ENTER correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_ARGUMENT_VALIDATION correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_COMMAND_LOCK correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();

  select * into v_receipt from public.production_attempt_consumption_receipts where command_identity=v_key;
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_RECEIPT_LOOKUP correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  if found then
    ...
    raise log 'OP_ATTEMPT_CONSUME marker=RETURNING correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_PRODUCTION_JOB_LOCK correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_PRODUCTION_CONCURRENCY_CHECK correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_ORDER_VALIDATION correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_ATTEMPT_RESOLUTION correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  if coalesce(v_job.exclude_inventory_reduction,false) then
    ...
    raise log 'OP_ATTEMPT_CONSUME marker=AFTER_ROLL_USAGE_VALIDATION correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
    ...
    for v_usage in select (u->>'raw_material_roll_id')::uuid roll_id,(u->>'grams_used')::numeric grams from jsonb_array_elements(p_roll_usages) u order by 1 loop
      raise log 'OP_ATTEMPT_CONSUME marker=BEFORE_RESERVATION_ROLL_LOCK correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      begin
      ...
      raise log 'OP_ATTEMPT_CONSUME marker=AFTER_RESERVATION_ROLL_LOCK correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      ...
      raise log 'OP_ATTEMPT_CONSUME marker=BEFORE_RAW_MATERIAL_UPDATE correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      ...
      raise log 'OP_ATTEMPT_CONSUME marker=AFTER_RAW_MATERIAL_UPDATE correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      raise log 'OP_ATTEMPT_CONSUME marker=BEFORE_RESERVATION_UPDATE correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      ...
      raise log 'OP_ATTEMPT_CONSUME marker=AFTER_RESERVATION_UPDATE correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      raise log 'OP_ATTEMPT_CONSUME marker=BEFORE_INVENTORY_TRANSACTION_INSERT correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
      ...
      raise log 'OP_ATTEMPT_CONSUME marker=AFTER_INVENTORY_TRANSACTION_INSERT correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), v_usage.roll_id, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=BEFORE_RECEIPT_INSERT correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  ...
  raise log 'OP_ATTEMPT_CONSUME marker=AFTER_RECEIPT_INSERT correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  raise log 'OP_ATTEMPT_CONSUME marker=RETURNING correlation_id=% attempt_id=% production_job_id=% backend_pid=% txid=% roll_id=% at=%', v_key, p_attempt_id, p_production_job_id, pg_backend_pid(), txid_current_if_assigned(), null::uuid, clock_timestamp();
  return v_result;
