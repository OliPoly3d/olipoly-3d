...
export interface DraftPlayer{id:Id;canonicalPlayerId:Id|null;displayName:string;normalizedName:string;position:Position;nflTeam?:string;byeWeek?:number;baselineRank?:number;fixtureTier?:number;baselineValue?:number;currentBaselineRank?:number;currentTier?:number;currentAdp?:number;playerIntelligence?:import('../data/player-data').PlayerIntelligence;relationships?:PlayerRelationship[]}
...
export interface OffseasonBriefingContext{id:Id;leagueId:Id;seasonId:Id;draftSessionId?:Id;playerId:Id;position:Position;team?:string;role?:string;injuryStatus?:string;currentNews?:string[];rankingContext?:string;freshness?:string;uncertaintyFlags?:string[];playerDataSnapshotId?:string;philosophyPreferenceIds:Id[];playerInterestId?:Id;createdAt:string}
