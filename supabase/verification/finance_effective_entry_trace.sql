...
select
  ...
  o.sales_county as original_county,
  o.sales_tax_rate as original_rate,
  c.metadata_entry_id,
  c.correction_group_id,
  c.correction_kind,
  c.changed_fields,
  c.effective_record->>'sales_county' as corrected_county,
  (c.effective_record->>'sales_tax_rate')::numeric as corrected_rate,
  e.row->>'sales_county' as effective_county,
  (e.row->>'sales_tax_rate')::numeric as effective_rate,
  (e.row->>'amount')::numeric as effective_amount,
