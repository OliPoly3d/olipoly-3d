...
export const normalizeByeWeek=(value:unknown):number|undefined=>{const week=Number(value);return Number.isInteger(week)&&week>=1&&week<=18?week:undefined};
